...
public class BoardDaoImpl implements BoardDao {
    ...
    public Board updateBoard(String uId, ChangeBoardDto changeBoardDto) throws Exception {
        ...
        if(selectedBoard.isPresent()) {
            ...
            board.setRecipe(changeBoardDto.getRecipe());
            board.setRingredients(changeBoardDto.getRingredients());
            board.setUrl(changeBoardDto.getUrl());
    ...
    @Override
    public List<Board> listAllBoardByRingredients(String search) {
        List<Board> boardList = boardRepository.findAllByRingredientsContaining(search);
        return boardList;
    }
}
